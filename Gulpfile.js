// Generated on 2015-03-26 using generutor-legen 0.0.5
'use strict';
// Инициализируем плагины
var gulp    = require('gulp'), // Сообственно Gulp JS
    css     = require('gulp-stylus'), // CSS preprocessor
...
gulp.task('watch', function () {
    gulp.watch(['./app/src/stylus/**/*.styl'], ['css']);
...
gulp.task('build', function() {
    ...
    gulp.src(['./app/src/coffee/**/*.js', './app/assets/coffee/**/*.js'])
        //.pipe(coffee({bare: true}))
        // .pipe(uglify())
